...
const DBC toyota_nodsu_hybrid_pt_generated_rav4h_tss2 = {
  .name = "toyota_nodsu_hybrid_pt_generated_rav4h_tss2",
...
dbc_init(toyota_nodsu_hybrid_pt_generated_rav4h_tss2)